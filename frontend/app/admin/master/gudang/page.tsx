...
export default function Page() {
    const [data, setData] = useState<Product[]>([
        { id: 1, nama_gudang: "Gudang Pusat", alamat: "Bandung", nama_pic: "Budi", no_pic: "08123456789" },
        { id: 2, nama_gudang: "Gudang Timur", alamat: "Surabaya", nama_pic: "Siti", no_pic: "08234567890" },
    ]);
    ...
    return (
        <div className="p-6 space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-xl font-bold">Data Gudang</h1>
            </div>
